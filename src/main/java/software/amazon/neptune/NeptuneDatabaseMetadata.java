...
import software.amazon.neptune.gremlin.GremlinDatabaseMetadata;
import java.sql.ResultSet;
import java.sql.SQLException;

public abstract class NeptuneDatabaseMetadata extends DatabaseMetaData implements java.sql.DatabaseMetaData {
