...
import software.aws.performance.implementations.executors.OpenCypherBaselineExecutor;
...
@Disabled
public class OpenCypherBaselineTest extends DataTypePerformance {

    @Override
    @SneakyThrows
    protected PerformanceTestExecutor getPerformanceTestExecutor() {
        return new OpenCypherBaselineExecutor();
    }
